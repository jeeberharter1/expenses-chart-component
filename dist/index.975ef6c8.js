...
let color = (0, _dataJsonDefault.default).map((x)=>getComputedStyle(document.documentElement).getPropertyValue("--color-primary"));
// assign new color value to max element
color[argMax((0, _dataJsonDefault.default))] = getComputedStyle(document.documentElement).getPropertyValue("--color-bar-primary");
new (0, _autoDefault.default)(document.getElementById("graph"), {
    type: "bar",
    options: {
    ...
    data: {
        labels: (0, _dataJsonDefault.default).map((row)=>row.day),
        datasets: [
            {
                data: (0, _dataJsonDefault.default).map((row)=>row.amount),
                borderRadius: 3,
...
},{"chart.js/auto":"d8NN9","../data.json":"cn6Iz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d8NN9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"cn6Iz":[function(require,module,exports) {
...
},{}]},["igKGj","8lqZg"], "8lqZg", "parcelRequire30ab")
